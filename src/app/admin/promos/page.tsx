  ...
  return (
    <AdminShell title="Промокоды">
      <div className="ui-card table-card">
        ...
        <div className="table-row"><span>FREE_ACCESS</span><span>будущий доступ</span><span>выключен</span></div>
        <div className="table-row"><span>PARTNER99</span><span>партнёрский</span><span>выключен</span></div>
      </div>
    </AdminShell>
  );
}
