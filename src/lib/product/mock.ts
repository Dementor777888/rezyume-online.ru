...
export const templates: TemplateMeta[] = [
  ...
  },
  {
    ...
    label: "Скоро",
    tier: "locked",
    description: "Сдержанный paid-пресет с широким хедером и светлым сайдбаром.",
  ...
  },
  {
    ...
    label: "Скоро",
    tier: "locked",
    description: "Контрастный сайдбар и строгая paid-типографика.",
...
export const catalogSections = [
  ...
  },
  {
    slug: "it",
    name: "IT и digital",
    intro: "Примеры для разработки, аналитики, поддержки и digital-команд.",
    professions: [
...
export const faqItems = [
  ...
  ["Какие шаблоны доступны сейчас?", "В рабочем free flow доступны «Старт» и «Старт+фото». Остальные показаны как locked preview."],
  ["Нужно ли заводить кабинет?", "Для бесплатного резюме кабинет не нужен: черновик хранится в браузере."],
  ["Что будет подключаться позже?", "Платёжный модуль, кабинет, paid-шаблоны, дополнительные форматы и AI-функции подключаются отдельными этапами."]
];
